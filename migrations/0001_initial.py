# Generated by Django 4.2.9 on 2024-02-08 01:48
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('phone_number', models.TextField(help_text='Enter the 11 digit phone number in the format 1234567890 (no spaces or dashes).', unique=True)),
                ('phone_number_key', models.BinaryField()),
                ('phone_number_hash', models.CharField(blank=True, max_length=64, null=True, unique=True)),
                ('name', models.TextField(default='Anonymous', help_text='Enter a first name for this number.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('phone_number', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='base.phonenumber')),
            ],
        ),
        migrations.CreateModel(
